var Guppy = (function() {
    ...
    AST.to_xml = function(ast, symbols, symbol_to_node) {
        ...
        var get_content_array = function get_content_array(args) {
            ...
            for (var i = 0; i < args.length; i++) {
                ...
                if (args[i].documentElement.nodeName == "l") content[i].push(args[i].documentElement);
                    ...
                    for (var nn = args[i].documentElement.firstChild; nn; nn = nn.nextSibling) {
                        content[i].push(nn);
                    }
            }
            return content;
        ...
        var binop_low = function binop_low(args, op, parent) {
            ...
            if (parent && (parent[0] == "*" || parent[0] == "-" && parent[1].length == 1)) return make_sym("bracket", [d]);
            else return d;
        };
            ...
            return function(r) {
                ...
                var p = function() {
                    ...
                    n = function e(t, r) {
                        ...
                        if (a && a.start <= a.end) {
                            ...
                            i += (15 < n ? '\u2026' + o.slice(n - 15, n) : o.slice(0, n)) + l + (s + 15 < o.length ? o.slice(s, s + 15) + '\u2026' : o.slice(s));
                        }
                        var h = new Error(i);
                    ...
                    h = function() {
                        ...
                        return t.reportNonstrict = function(e, t, r) {
                            ...
                            if ("function" == typeof n && (n = n(e, t, r)), n && "ignore" !== n) {
                                if (!0 === n || "error" === n) throw new X("LaTeX-incompatible input and strict mode is set to 'error': " + t + " [" + e + "]", r);
                ...
                var k = {
                    ...
                    T = function T(e) {
                        ...
                        for (var r in t.className = z(this.classes), this.style) {
                    ...
                    A = function A(e) {
                        var t = "<" + e;
                        this.classes.length && (t += ' class="' + Y.escape(z(this.classes)) + '"');
                        var r = "";
                    ...
                    O = function() {
                        function e(e, t, r, n, i, a, o, s) {
                            this.text = void 0, this.height = void 0, this.depth = void 0, this.italic = void 0, this.skew = void 0, this.width = void 0, this.maxFontSize = void 0, this.classes = void 0, this.style = void 0, this.text = e, this.height = t || 0, this.depth = r || 0, this.italic = n || 0, this.skew = i || 0, this.width = a || 0, this.classes = o || [], this.style = s || {}, this.maxFontSize = 0;
                            var l = function(e) {
                        ...
                        return t.hasClass = function(e) {
                            ...
                            var e = document.createTextNode(this.text),
                                t = null;
                            for (var r in 0 < this.italic && ((t = document.createElement("span")).style.marginRight = this.italic + "em"), 0 < this.classes.length && ((t = t || document.createElement("span")).className = z(this.classes)), this.style) {
                            ...
                            var e = !1,
                                t = "<span";
                            this.classes.length && (e = !0, t += ' class="', t += Y.escape(z(this.classes)), t += '"');
                            var r = "";
                            for (var n in 0 < this.italic && (r += "margin-right:" + this.italic + "em;"), this.style) {
                                this.style.hasOwnProperty(n) && (r += Y.hyphenate(n) + ":" + this.style[n] + ";");
                            }
                            r && (e = !0, t += ' style="' + Y.escape(r) + '"');
                    ...
                    R = function() {
                        ...
                        return t.toNode = function() {
                            ...
                            return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", k.path[this.pathName]), e;
                        }, t.toMarkup = function() {
                ...
                function F(e, t, r) {
                    if (!H[t]) throw new Error("Font metrics not found for font: " + t + ".");
                    var n = e.charCodeAt(0);
                    e[0] in P && (n = P[e[0]].charCodeAt(0));
                    var i = H[t][n];
                    if (i || "text" !== r || w(n) && (i = H[t][77]), i) return {
                        depth: i[0],
                        height: i[1],
                        italic: i[2],
                        skew: i[3],
                ...
                j(Z, K, he, '\u2013', "--"), j(Z, K, he, '\u2013', "\\textendash"), j(Z, K, he, '\u2014', "---"), j(Z, K, he, '\u2014', "\\textemdash"), j(Z, K, he, '\u2018', "`"), j(Z, K, he, '\u2018', "\\textquoteleft"), j(Z, K, he, '\u2019', "'"), j(Z, K, he, '\u2019', "\\textquoteright"), j(Z, K, he, '\u201C', "``"), j(Z, K, he, '\u201C', "\\textquotedblleft"), j(Z, K, he, '\u201D', "''"), j(Z, K, he, '\u201D', "\\textquotedblright"), j($, K, he, "\xb0", "\\degree", !0), j(Z, K, he, "\xb0", "\\degree"), j(Z, K, he, "\xb0", "\\textdegree", !0), j($, K, ne, "\xa3", "\\pounds"), j($, K, ne, "\xa3", "\\mathsterling", !0), j(Z, K, ne, "\xa3", "\\pounds"), j(Z, K, ne, "\xa3", "\\textsterling", !0), j($, J, he, '\u2720', "\\maltese"), j(Z, J, he, '\u2720', "\\maltese"), j(Z, K, le, "\xa0", "\\ "), j(Z, K, le, "\xa0", " "), j(Z, K, le, "\xa0", "~");
                for (var ce = '0123456789/@."', ue = 0; ue < ce.length; ue++) {
                    var pe = ce.charAt(ue);
                    j($, K, he, pe, pe);
                }
                ...
                for (var ve = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", ye = 0; ye < ve.length; ye++) {
                    var be = ve.charAt(ye);
                    j($, K, ne, be, be), j(Z, K, he, be, be);
                }
                j($, J, he, "C", '\u2102'), j(Z, J, he, "C", '\u2102'), j($, J, he, "H", '\u210D'), j(Z, J, he, "H", '\u210D'), j($, J, he, "N", '\u2115'), j(Z, J, he, "N", '\u2115'), j($, J, he, "P", '\u2119'), j(Z, J, he, "P", '\u2119'), j($, J, he, "Q", '\u211A'), j(Z, J, he, "Q", '\u211A'), j($, J, he, "R", '\u211D'), j(Z, J, he, "R", '\u211D'), j($, J, he, "Z", '\u2124'), j(Z, J, he, "Z", '\u2124'), j($, K, ne, "h", '\u210E'), j(Z, K, ne, "h", '\u210E');
                for (var xe = "", we = 0; we < ve.length; we++) {
                    var ke = ve.charAt(we);
                    j($, K, ne, ke, xe = String.fromCharCode(55349, 56320 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56372 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56424 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56580 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56736 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56788 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56840 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56944 + we)), j(Z, K, he, ke, xe), we < 26 && (j($, K, ne, ke, xe = String.fromCharCode(55349, 56632 + we)), j(Z, K, he, ke, xe), j($, K, ne, ke, xe = String.fromCharCode(55349, 56476 + we)), j(Z, K, he, ke, xe));
                }
                j($, K, ne, "k", xe = String.fromCharCode(55349, 56668)), j(Z, K, he, "k", xe);
                for (var Se = 0; Se < 10; Se++) {
                    var ze = Se.toString();
                    j($, K, ne, ze, xe = String.fromCharCode(55349, 57294 + Se)), j(Z, K, he, ze, xe), j($, K, ne, ze, xe = String.fromCharCode(55349, 57314 + Se)), j(Z, K, he, ze, xe), j($, K, ne, ze, xe = String.fromCharCode(55349, 57324 + Se)), j(Z, K, he, ze, xe), j($, K, ne, ze, xe = String.fromCharCode(55349, 57334 + Se)), j(Z, K, he, ze, xe);
                }
                for (var Me = "\xc7\xd0\xde\xe7\xfe", Te = 0; Te < Me.length; Te++) {
                    var Ae = Me.charAt(Te);
                    j($, K, ne, Ae, Ae), j(Z, K, he, Ae, Ae);
                }
                j(Z, K, he, "\xf0", "\xf0"), j(Z, K, he, '\u2013', '\u2013'), j(Z, K, he, '\u2014', '\u2014'), j(Z, K, he, '\u2018', '\u2018'), j(Z, K, he, '\u2019', '\u2019'), j(Z, K, he, '\u201C', '\u201C'), j(Z, K, he, '\u201D', '\u201D');
                var Be = [
                    ...
                    Oe = function() {
                        ...
                        return e.extend = function(e) {
                            ...
                            e = e || this.style.text();
                            var t = Ee(n.BASESIZE, e);
                            return this.size === t && this.textSize === n.BASESIZE && this.style === e ? this : this.extend({
                                style: e,
                                size: t
                            });
                            ...
                            return this._fontMetrics || (this._fontMetrics = function(e) {
                                var t;
                                if (!V[t = 5 <= e ? 0 : 3 <= e ? 1 : 2]) {
                                    var r = V[t] = {
                                        cssEmPerMu: D.quad[t] / 18
                                    };
                                    for (var n in D) {
                ...
                var Ie = Oe,
                    ...
                    De = function De(e, t) {
                        var r;
                        if (e.unit in Re) r = Re[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                            ...
                            if (n = t.style.isTight() ? t.havingStyle(t.style.text()) : t, "ex" === e.unit) r = n.fontMetrics().xHeight;
                                ...
                                if ("em" !== e.unit) throw new X("Invalid unit: '" + e.unit + "'");
                    ...
                    Fe = function Fe(e, t, r) {
                        return W[r][e] && W[r][e].replace && (e = W[r][e].replace), {
                            value: e,
                            metrics: F(e, t, r)
                        };
                    },
                    Ve = function Ve(e, t, r, n, i) {
                        ...
                        if (e = o.value, s) {
                            var l = s.italic;
                            ("text" === r || n && "mathit" === n.font) && (l = 0), a = new O(e, s.height, s.depth, l, s.skew, s.width, i);
                        } else "undefined" != typeof console && console.warn("No character metrics for '" + e + "' in style '" + t + "'"), a = new O(e, 0, 0, 0, 0, 0, i);
                        if (n) {
                    ...
                    Ze = {
                        ...
                        makeVList: function makeVList(e, t) {
                            ...
                            var h = Xe(["pstrut"], []);
                            h.style.height = a + "em";
                            for (var m = [], c = i, u = i, p = i, d = 0; d < n.length; d++) {
                                var f = n[d];
                                if ("kern" === f.type) p += f.size;
                                    ...
                                    var g = f.elem,
                                        ...
                                        y = f.wrapperStyle || {},
                                        b = Xe(v, [h, g], void 0, y);
                                    b.style.top = -a - p - g.depth + "em", f.marginLeft && (b.style.marginLeft = f.marginLeft), f.marginRight && (b.style.marginRight = f.marginRight), m.push(b), p += g.height + g.depth;
                                }
                            ...
                            if (w.style.height = u + "em", c < 0) {
                                var k = Xe([], []),
                                    S = Xe(["vlist"], [k]);
                                S.style.height = -c + "em";
                                var z = Xe(["vlist-s"], [new O('\u200B')]);
                                x = [Xe(["vlist-r"], [w, z]), Xe(["vlist-r"], [S])];
                            } else x = [Xe(["vlist-r"], [w])];
                            var M = Xe(["vlist-t"], x);
                            return 2 === x.length && M.classes.push("vlist-t2"), M.height = u, M.depth = -c, M;
                        },
                        makeOrd: function makeOrd(e, t, r) {
                            ...
                            if (l) {
                                ...
                                } else p = Y.contains(Pe, a) ? (u = "Main-Italic", ["mathit"]) : s ? (u = je[l].fontName, [l]) : (u = We(l, t.fontWeight, t.fontShape), [l, t.fontWeight, t.fontShape]);
                                if (Fe(a, u, i).metrics) return Ve(a, u, i, t, o.concat(p));
                                if (me.hasOwnProperty(a) && "Typewriter" === u.substr(0, 10)) {
                            ...
                            if ("mathord" === r) {
                                var v = /[0-9]/.test((w = a).charAt(0)) || Y.contains(Pe, w) ? {
                                    fontName: "Main-Italic",
                                    fontClass: "mathit"
                                } : {
                                    fontName: "Math-Italic",
                                ...
                                return Ve(a, v.fontName, i, t, o.concat([v.fontClass]));
                            }
                            if ("textord" !== r) throw new Error("unexpected type: " + r + " in makeOrd");
                            var y = W[i][a] && W[i][a].font;
                            if ("ams" === y) {
                                var b = We("amsrm", t.fontWeight, t.fontShape);
                                return Ve(a, b, i, t, o.concat("amsrm", t.fontWeight, t.fontShape));
                            }
                            if ("main" !== y && y) {
                                var x = We(y, t.fontWeight, t.fontShape);
                                return Ve(a, x, i, t, o.concat(x, t.fontWeight, t.fontShape));
                            }
                            var w,
                                k = We("textrm", t.fontWeight, t.fontShape);
                            return Ve(a, k, i, t, o.concat(t.fontWeight, t.fontShape));
                        },
                        ...
                        tryCombineChars: function tryCombineChars(e) {
                            for (var t = 0; t < e.length - 1; t++) {
                                var r = e[t],
                                    n = e[t + 1];
                                r instanceof O && n instanceof O && Ue(r, n) && (r.text += n.text, r.height = Math.max(r.height, n.height), r.depth = Math.max(r.depth, n.depth), r.italic = n.italic, e.splice(t + 1, 1), t--);
                            }
                            return e;
                        }
                    };
                ...
                function Ke(e, t) {
                    var r = Je(e, t);
                    if (!r) throw new Error("Expected node of type " + t + ", but got " + (e ? "node of type " + e.type : String(e)));
                    return r;
                }
                ...
                function Qe(e, t) {
                    var r,
                        n,
                        i = (n = t, (r = e) && "atom" === r.type && r.family === n ? r : null);
                    if (!i) throw new Error('Expected node of type "atom" and family "' + t + '", but got ' + (e ? "atom" === e.type ? "atom of family " + e.family : "node of type " + e.type : String(e)));
                    return i;
                }
                ...
                function ht(e) {
                    for (var t = e.type, r = (e.nodeType, e.names), n = e.props, i = e.handler, a = e.htmlBuilder, o = e.mathmlBuilder, s = {
                            type: t,
                            numArgs: n.numArgs,
                            argTypes: n.argTypes,
                ...
                var ct = function ct(e) {
                    ...
                    vt = function vt(e, t, r, n) {
                        ...
                        var l = t;
                        if (1 === e.length) {
                            var h = Je(e[0], "sizing") || Je(e[0], "styling");
                            h && ("sizing" === h.type ? l = t.havingSize(h.size) : "styling" === h.type && (l = t.havingStyle(ft[h.style])));
                        }
                        var m = ut([n[0] || "leftmost"], [], t),
                            c = ut([n[1] || "rightmost"], [], t);
                        return yt(i, function(e, t) {
                            var r = t.classes[0],
                                n = e.classes[0];
                            "mbin" === r && Y.contains(dt, n) ? t.classes[0] = "mord" : "mbin" === n && Y.contains(pt, r) && (e.classes[0] = "mord");
                        }, {
                            node: m
                        }, c), yt(i, function(e, t) {
                            var r = xt(t),
                                n = xt(e),
                                i = r && n ? e.hasClass("mtight") ? at[r][n] : it[r][n] : null;
                            if (i) return Ze.makeGlue(i, l);
                        }, {
                            node: m
                        }, c), i;
                    },
                    yt = function e(r, t, n, i) {
                        ...
                        for (var a = 0; a < r.length; a++) {
                            var o = r[a],
                                s = bt(o);
                            if (s) e(s.children, t, n);
                            else if ("mspace" !== o.classes[0]) {
                                var l = t(o, n.node);
                                l && (n.insertAfter ? n.insertAfter(l) : (r.unshift(l), a++)), n.node = o, n.insertAfter = function(t) {
                                    return function(e) {
                                        r.splice(t + 1, 0, e), a++;
                                    };
                                }(a);
                ...
                function zt(e, t) {
                    ...
                    for (var n, i = vt(e, t, !0), a = [], o = [], s = 0; s < i.length; s++) {
                    ...
                    0 < o.length && a.push(St(o, t)), r && ((n = St(vt(r, t, !0))).classes = ["tag"], a.push(n));
                    var h = ut(["katex-html"], a);
                ...
                var Tt = function() {
                    ...
                    qt = function qt(e, t) {
                        ...
                        var i = e.text;
                        return Y.contains(["\\imath", "\\jmath"], i) ? null : (W[n][i] && W[n][i].replace && (i = W[n][i].replace), F(i, Ze.fontMap[r].fontName, n) ? Ze.fontMap[r].variant : null);
                    },
                    Et = function Et(e, t) {
                        for (var r, n = [], i = 0; i < e.length; i++) {
                            var a = It(e[i], t);
                            if (a instanceof Tt && r instanceof Tt) {
                    ...
                    It = function It(e, t) {
                        if (!e) return new Bt.MathNode("mrow");
                ...
                var Rt = function Rt(e) {
                    ...
                    Lt = function Lt(e, t, r) {
                        var n = Rt(r),
                            i = function(e, t, r) {
                                var n,
                                    i = Et(e, r);
                                n = 1 === i.length && i[0] instanceof Tt && Y.contains(["mrow", "mtable"], i[0].type) ? i[0] : new Bt.MathNode("mrow", i);
                                var a = new Bt.MathNode("annotation", [new Bt.TextNode(t)]);
                                a.setAttribute("encoding", "application/x-tex");
                                var o = new Bt.MathNode("semantics", [n, a]),
                                    s = new Bt.MathNode("math", [o]);
                                return Ze.makeSpan(["katex-mathml"], [s]);
                            }(e, t, n),
                            a = zt(e, n),
                            o = Ze.makeSpan(["katex"], [i, a]);
                        return r.displayMode ? Ze.makeSpan(["katex-display"], [o]) : o;
                    },
                    Ht = {
                        widehat: "^",
                        widecheck: '\u02C7',
                    ...
                    Pt = function Pt(e, t, r, n) {
                        ...
                        if (/fbox|color/.test(t)) {
                            ...
                            var s = [];
                            /^[bx]cancel$/.test(t) && s.push(new L({
                                x1: "0",
                                y1: "0",
                                x2: "100%",
                                y2: "100%",
                                "stroke-width": "0.046em"
                            })), /^x?cancel$/.test(t) && s.push(new L({
                                x1: "0",
                                y1: "100%",
                                x2: "100%",
                                y2: "0",
                            ...
                            i = Ze.makeSvgSpan([], [l], n);
                        }
                        return i.height = a, i.style.height = a + "em", i;
                    },
                    Ft = function Ft(e) {
                        var t = new Bt.MathNode("mo", [new Bt.TextNode(Ht[e.substr(1)])]);
                    ...
                    Vt = function Vt(S, z) {
                        var e = function() {
                                var e = 4e5,
                                    t = S.label.substr(1);
                                if (Y.contains(["widehat", "widecheck", "widetilde", "utilde"], t)) {
                                    var r,
                                        n,
                                        i,
                                        a = "ordgroup" === (c = S.base).type ? c.body.length : 1;
                                    if (5 < a) n = "widehat" === t || "widecheck" === t ? (r = 420, e = 2364, i = .42, t + "4") : (r = 312, e = 2340, i = .34, "tilde4");
                                    else {
                                        var o = [1, 1, 2, 2, 3, 3][a];
                                        n = "widehat" === t || "widecheck" === t ? (e = [0, 1062, 2364, 2364, 2364][o], r = [0, 239, 300, 360, 420][o], i = [0, .24, .3, .3, .36, .42][o], t + o) : (e = [0, 600, 1033, 2339, 2340][o], r = [0, 260, 286, 306, 312][o], i = [0, .26, .286, .3, .306, .34][o], "tilde" + o);
                                    }
                                    var s = new R(n),
                                        l = new I([s], {
                                            width: "100%",
                                ...
                                var h,
                                    ...
                                    v = g / 1e3,
                                    y = d.length;
                                if (1 === y) h = ["hide-tail"], m = [p[3]];
                                else if (2 === y) h = ["halfarrow-left", "halfarrow-right"], m = ["xMinYMin", "xMaxYMin"];
                                else {
                                    if (3 !== y) throw new Error("Correct katexImagesData or update code here to support\n                    " + y + " children.");
                                    h = ["brace-left", "brace-center", "brace-right"], m = ["xMinYMin", "xMidYMin", "xMaxYMin"];
                                }
                                for (var b = 0; b < y; b++) {
                                    var x = new R(d[b]),
                                        w = new I([x], {
                                        ...
                                        k = Ze.makeSvgSpan([h[b]], [w], z);
                                    if (1 === y) return {
                                        span: k,
                                        minWidth: f,
                                        height: v
                                    };
                                    k.style.height = v + "em", u.push(k);
                                }
                                return {
                                    span: Ze.makeSpan(["stretchy"], u, z),
                                    minWidth: f,
                                    height: v
                                };
                            }(),
                            ...
                            r = e.minWidth,
                            n = e.height;
                        return t.height = n, t.style.height = n + "em", 0 < r && (t.style.minWidth = r + "em"), t;
                    },
                    Ut = function Ut(e, t) {
                        var r,
                            n,
                            i,
                            a = Je(e, "supsub");
                        a ? (r = (n = Ke(a.base, "accent")).base, a.base = r, i = function(e) {
                            if (e instanceof B) return e;
                            throw new Error("Expected span<HtmlDomNode> but got " + String(e) + ".");
                        }(kt(a, t)), a.base = n) : r = (n = Ke(e, "accent")).base;
                        var o = kt(r, t.havingCrampedStyle()),
                            s = 0;
                        if (n.isShifty && Y.isCharacterBox(r)) {
                            var l = Y.getBaseElem(r);
                            s = function(e) {
                        ...
                        var h,
                            m = Math.min(o.height, t.fontMetrics().xHeight);
                        if (n.isStretchy) h = Vt(n, t), h = Ze.makeVList({
                            ...
                            var c, u;
                            u = "\\vec" === n.label ? (c = Ze.staticSvg("vec", t), Ze.svgData.vec[1]) : ((c = Ze.makeSymbol(n.label, "Main-Regular", n.mode, t)).italic = 0, c.width), h = Ze.makeSpan(["accent-body"], [c]);
                            var p = "\\textcircled" === n.label;
                            p && (h.classes.push("accent-full"), m = o.height);
                            var d = s;
                            p || (d -= u / 2), h.style.left = d + "em", "\\textcircled" === n.label && (h.style.top = ".2em"), h = Ze.makeVList({
                                positionType: "firstBaseline",
                                children: [{
                                    type: "elem",
                                    elem: o
                        ...
                        var f = Ze.makeSpan(["mord", "accent"], [h], t);
                        return i ? (i.children[0] = f, i.height = Math.max(f.height, i.height), i.classes[0] = "mord", i) : f;
                    },
                    Gt = function Gt(e, t) {
                        var r = e.isStretchy ? Ft(e.label) : new Bt.MathNode("mo", [Ct(e.label, e.mode)]),
                            n = new Bt.MathNode("mover", [It(e.base, t), r]);
                ...
                ht({
                    ...
                    handler: function handler(e, t) {
                        var r = t[0],
                            ...
                            i = !n || "\\widehat" === e.funcName || "\\widetilde" === e.funcName || "\\widecheck" === e.funcName;
                        return {
                            type: "accent",
                            mode: e.parser.mode,
                            label: e.funcName,
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        ...
                        return Ze.makeSpan(["mord", "accentunder"], [a], t);
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = Ft(e.label),
                            n = new Bt.MathNode("munder", [It(e.base, t), r]);
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r,
                            ...
                            a = Ze.wrapFragment(kt(e.body, i, t), t);
                        a.classes.push("x-arrow-pad"), e.below && (i = t.havingStyle(n.sub()), (r = Ze.wrapFragment(kt(e.below, i, t), t)).classes.push("x-arrow-pad"));
                        var o,
                            s = Vt(e, t),
                            l = -t.fontMetrics().axisHeight + .5 * s.height,
                            h = -t.fontMetrics().axisHeight - .5 * s.height - .111;
                        if ((.25 < a.depth || "\\xleftequilibrium" === e.label) && (h -= a.depth), r) {
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        ...
                        if (e.body) {
                            var a = It(e.body, t);
                            r = e.below ? (n = It(e.below, t), new Bt.MathNode("munderover", [i, n, a])) : new Bt.MathNode("mover", [i, a]);
                        } else r = e.below ? (n = It(e.below, t), new Bt.MathNode("munder", [i, n])) : new Bt.MathNode("mover", [i]);
                        return r;
                    }
                }), ht({
                    type: "textord",
                    ...
                    handler: function handler(e, t) {
                        ...
                        var o = parseInt(i);
                        if (isNaN(o)) throw new X("\\@char has non-numeric argument " + i);
                        return {
                            type: "textord",
                            mode: r.mode,
                            text: String.fromCharCode(o)
                        };
                    }
                });
                ...
                ht({
                    ...
                    handler: function handler(e, t, r) {
                        ...
                        return o || (s = !n.settings.displayMode || !n.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode")), {
                            ...
                            newLine: s,
                            newRow: o,
                            size: a && Ke(a, "size").value
                        };
                    },
                    htmlBuilder: function htmlBuilder(e, t) {
                        if (e.newRow) throw new X("\\cr valid only within a tabular/array environment");
                        var r = Ze.makeSpan(["mspace"], [], t);
                        return e.newLine && (r.classes.push("newline"), e.size && (r.style.marginTop = De(e.size, t) + "em")), r;
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mspace");
                        return e.newLine && (r.setAttribute("linebreak", "newline"), e.size && r.setAttribute("height", De(e.size, t) + "em")), r;
                    }
                });
                var Wt = function Wt(e, t, r) {
                        var n = F(W.math[e] && W.math[e].replace || e, t, r);
                    ...
                    $t = function $t(e, t, r) {
                        ...
                        e.classes.push("delimcenter"), e.style.top = i + "em", e.height -= i, e.depth += i;
                    },
                    Zt = function Zt(e, t, r, n, i, a) {
                        var o,
                            ...
                            c = jt(Ze.makeSpan(["delimsizing", "size" + t], [m], n), q.TEXT, n, a);
                        return r && $t(c, n, q.TEXT), c;
                    },
                    Kt = function Kt(e, t, r) {
                        var n;
                    ...
                    Jt = function Jt(e, t, r, n, i, a) {
                        ...
                        M.push(Kt(o, m, i));
                        var C = n.havingBaseStyle(q.TEXT),
                            N = Ze.makeVList({
                                positionType: "bottom",
                                positionData: z,
                                children: M
                            }, C);
                        return jt(Ze.makeSpan(["delimsizing", "mult"], [N], C), q.TEXT, n, a);
                    },
                    Qt = function Qt(e, t, r, n) {
                        var i;
                        "sqrtTall" === e && (i = "M702 80H400000v40H742v" + (r - 54 - 80) + "l-4 4-4 4c-.667.7\n-2 1.5-4 2.5s-4.167 1.833-6.5 2.5-5.5 1-9.5 1h-12l-28-84c-16.667-52-96.667\n-294.333-240-727l-212 -643 -85 170c-4-3.333-8.333-7.667-13 -13l-13-13l77-155\n 77-156c66 199.333 139 419.667 219 661 l218 661zM702 80H400000v40H742z");
                        var a = new R(e, i),
                            o = new I([a], {
                                width: "400em",
                                height: t + "em",
                        ...
                        return Ze.makeSvgSpan(["hide-tail"], [o], n);
                    },
                    ...
                    lr = function lr(e, t, r, n) {
                        for (var i = Math.min(2, 3 - n.style.size); i < r.length && "stack" !== r[i].type; i++) {
                            var a = Wt(e, sr(r[i]), "math"),
                                o = a.height + a.depth;
                            if ("small" === r[i].type && (o *= n.havingBaseStyle(r[i].style).sizeMultiplier), t < o) return r[i];
                        }
                        return r[r.length - 1];
                    },
                    hr = function hr(e, t, r, n, i, a) {
                        var o;
                        "<" === e || "\\lt" === e || '\u27E8' === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && '\u27E9' !== e || (e = "\\rangle"), o = Y.contains(rr, e) ? ir : Y.contains(er, e) ? or : ar;
                        var s,
                            l,
                            h,
                            m,
                            ...
                            d,
                            f = lr(e, t, o, n);
                        return "small" === f.type ? (s = e, l = f.style, h = r, m = n, c = i, u = a, p = Ze.makeSymbol(s, "Main-Regular", c, m), d = jt(p, l, m, u), h && $t(d, m, l), d) : "large" === f.type ? Zt(e, f.size, r, n, i, a) : Jt(e, t, r, n, i, a);
                    },
                    mr = function mr(e, t) {
                        var r,
                            n,
                            ...
                            l = 0,
                            h = 0;
                        return n = "small" === a.type ? (e < 1 ? o = 1 : e < 1.4 && (o = .7), l = 1 / o, (r = Qt("sqrtMain", s = 1.08 / o, h = 1080, t)).style.minWidth = "0.853em", .833 / o) : "large" === a.type ? (h = 1080 * nr[a.size], l = nr[a.size] / o, s = (nr[a.size] + .08) / o, (r = Qt("sqrtSize" + a.size, s, h, t)).style.minWidth = "1.02em", 1 / o) : (s = e + .08, l = e, h = Math.floor(1e3 * e) + 80, (r = Qt("sqrtTall", s, h, t)).style.minWidth = "0.742em", 1.056), r.height = l, r.style.height = s + "em", {
                            span: r,
                            advanceWidth: n,
                            ruleWidth: t.fontMetrics().sqrtRuleThickness * o
                        };
                    },
                    cr = function cr(e, t, r, n, i) {
                        if ("<" === e || "\\lt" === e || '\u27E8' === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && '\u27E9' !== e || (e = "\\rangle"), Y.contains(er, e) || Y.contains(rr, e)) return Zt(e, t, !1, r, n, i);
                        if (Y.contains(tr, e)) return Jt(e, nr[t], !1, r, n, i);
                ...
                function gr(e, t) {
                    var r = et(e);
                    if (r && Y.contains(fr, r.text)) return r;
                    throw new X("Invalid delimiter: '" + (r ? r.text : JSON.stringify(e)) + "' after '" + t.funcName + "'", e);
                }
                ...
                ht({
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        vr(e);
                        for (var r, n, i = vt(e.body, t, !0, ["mopen", "mclose"]), a = 0, o = 0, s = !1, l = 0; l < i.length; l++) {
                            i[l].isMiddle ? s = !0 : (a = Math.max(i[l].height, a), o = Math.max(i[l].depth, o));
                        }
                        if (a *= t.sizeMultiplier, o *= t.sizeMultiplier, r = "." === e.left ? wt(t, ["mopen"]) : pr(e.left, a, o, t, e.mode, ["mopen"]), i.unshift(r), s)
                            for (var h = 1; h < i.length; h++) {
                                var m = i[h].isMiddle;
                                m && (i[h] = pr(m.delim, a, o, m.options, e.mode, []));
                            }
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        ...
                        var r = Et(e.body, t);
                        if ("." !== e.left) {
                            var n = new Bt.MathNode("mo", [Ct(e.left, e.mode)]);
                            n.setAttribute("fence", "true"), r.unshift(n);
                        }
                        if ("." !== e.right) {
                            var i = new Bt.MathNode("mo", [Ct(e.right, e.mode)]);
                    ...
                    handler: function handler(e, t) {
                        var r = gr(t[0], e);
                        if (!e.parser.leftrightDepth) throw new X("\\middle without preceding \\left", r);
                        return {
                            type: "middle",
                            mode: e.parser.mode,
                            delim: r.text
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mo", [Ct(e.delim, e.mode)]);
                ...
                var yr = function yr(e, t) {
                        var r,
                            ...
                            o = t.sizeMultiplier,
                            s = 0,
                            l = Y.isCharacterBox(e.body);
                        if ("sout" === a)(r = Ze.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / o, s = -.5 * t.fontMetrics().xHeight;
                        else {
                            /cancel/.test(a) ? l || i.classes.push("cancel-pad") : i.classes.push("boxpad");
                            var h = 0;
                            h = /box/.test(a) ? "colorbox" === a ? .3 : .34 : l ? .2 : 0, r = Pt(i, a, h, t), s = i.depth + h, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor));
                        }
                        ...
                        }, t), /cancel/.test(a) && (n.height = i.height, n.depth = i.depth), /cancel/.test(a) && !l ? Ze.makeSpan(["mord", "cancel-lap"], [n], t) : Ze.makeSpan(["mord"], [n], t);
                    },
                    br = function br(e, t) {
                        var r = new Bt.MathNode("menclose", [It(e.body, t)]);
                        switch (e.label) {
                            case "\\cancel":
                ...
                function wr(e) {
                    for (var t = e.type, r = e.names, n = e.props, i = e.handler, a = e.htmlBuilder, o = e.mathmlBuilder, s = {
                            type: t,
                            numArgs: n.numArgs || 0,
                            greediness: 1,
                            allowedInText: !1,
                ...
                function Sr(e, t, r) {
                    var n = t.hskipBeforeAndAfter,
                        ...
                        a = t.cols,
                        o = t.arraystretch;
                    if (e.gullet.beginGroup(), e.gullet.macros.set("\\\\", "\\cr"), !o) {
                        var s = e.gullet.expandMacroAsText("\\arraystretch");
                        if (null == s) o = 1;
                        else if (!(o = parseFloat(s)) || o < 0) throw new X("Invalid \\arraystretch: " + s);
                    }
                    var l = [],
                        h = [l],
                        m = [],
                    ...
                    for (c.push(kr(e));;) {
                        ...
                        var p = e.nextToken.text;
                        if ("&" === p) e.consume();
                        else {
                            if ("\\end" === p) {
                                1 === l.length && "styling" === u.type && 0 === u.body[0].body.length && h.pop(), c.length < h.length + 1 && c.push([]);
                                break;
                            }
                            if ("\\cr" !== p) throw new X("Expected & or \\\\ or \\cr or \\end", e.nextToken);
                            var d = Ke(e.parseFunction(), "cr");
                            m.push(d.size), c.push(kr(e)), l = [], h.push(l);
                        }
                    }
                ...
                var Mr = function Mr(e, t) {
                        ...
                        for (v(a[0]), r = 0; r < e.body.length; ++r) {
                            ...
                            var w = new Array(y.length);
                            for (n = 0; n < y.length; ++n) {
                                var k = kt(y[n], t);
                                x < k.depth && (x = k.depth), b < k.height && (b = k.height), w[n] = k;
                            }
                            var S = e.rowGaps[r],
                                z = 0;
                            S && 0 < (z = De(S, t)) && (x < (z += f) && (x = z), z = 0), e.addJot && (x += u), w.height = b, w.depth = x, g += b, w.pos = g, g += x + z, s[r] = w, v(a[r + 1]);
                        }
                        var M,
                            T,
                            ...
                            B = e.cols || [],
                            C = [];
                        for (T = n = 0; n < o || T < B.length; ++n, ++T) {
                            for (var N = B[T] || {}, q = !0;
                                "separator" === N.type;) {
                                if (q || ((M = Ze.makeSpan(["arraycolsep"], [])).style.width = t.fontMetrics().doubleRuleSep + "em", C.push(M)), "|" === N.separator) {
                                    var E = Ze.makeSpan(["vertical-separator"], [], t);
                                    E.style.height = g + "em", E.style.verticalAlign = -(g - A) + "em", C.push(E);
                                } else {
                                    if (":" !== N.separator) throw new X("Invalid separator type: " + N.separator);
                                    var O = Ze.makeSpan(["vertical-separator", "vs-dashed"], [], t);
                                    O.style.height = g + "em", O.style.verticalAlign = -(g - A) + "em", C.push(O);
                                }
                                N = B[++T] || {}, q = !1;
                            }
                            if (!(o <= n)) {
                                var I = void 0;
                                (0 < n || e.hskipBeforeAndAfter) && 0 !== (I = Y.deflt(N.pregap, m)) && ((M = Ze.makeSpan(["arraycolsep"], [])).style.width = I + "em", C.push(M));
                                var R = [];
                                for (r = 0; r < i; ++r) {
                                    var L = s[r],
                                        H = L[n];
                                    if (H) {
                                        var D = L.pos - A;
                                        H.depth = L.depth, H.height = L.height, R.push({
                                            type: "elem",
                                            elem: H,
                                            shift: D
                                        });
                                ...
                                R = Ze.makeVList({
                                    positionType: "individualShift",
                                    children: R
                                }, t), R = Ze.makeSpan(["col-align-" + (N.align || "c")], [R]), C.push(R), (n < o - 1 || e.hskipBeforeAndAfter) && 0 !== (I = Y.deflt(N.postgap, m)) && ((M = Ze.makeSpan(["arraycolsep"], [])).style.width = I + "em", C.push(M));
                            }
                        }
                        if (s = Ze.makeSpan(["mtable"], C), 0 < l.length) {
                            for (var P = Ze.makeLineSpan("hline", t, .05), F = Ze.makeLineSpan("hdashline", t, .05), V = [{
                                    type: "elem",
                                    elem: s,
                                    shift: 0
                                }]; 0 < l.length;) {
                    ...
                    Ar = function Ar(e, t) {
                        ...
                        i.body.forEach(function(e) {
                            ...
                            if (m) a < e.length && (a = e.length);
                                ...
                                var r = e.length / 2;
                                if (n < r) throw new X("Too many math in a row: expected " + n + ", but got " + r, e[0]);
                            }
                        });
                        for (var c = 0; c < a; ++c) {
                            var u = "r",
                                p = 0;
                            c % 2 == 1 ? u = "l" : 0 < c && m && (p = 1), r[c] = {
                                type: "align",
                                align: u,
                                pregap: p,
                                postgap: 0
                ...
                wr({
                    ...
                    handler: function handler(e, t) {
                        var r = {
                            cols: (et(t[0]) ? [t[0]] : Ke(t[0], "ordgroup").body).map(function(e) {
                                var t = function(e) {
                                    var t = et(e);
                                ...
                                throw new X("Unknown column alignment: " + t, e);
                            }),
                            hskipBeforeAndAfter: !0
                        };
                        return Sr(e.parser, r, zr(e.envName));
                    },
                    htmlBuilder: Mr,
                    mathmlBuilder: Tr
                }), wr({
                ...
                ht({
                    ...
                    handler: function handler(e, t) {
                        var r = e.parser,
                            n = e.funcName,
                            i = t[0];
                        if ("ordgroup" !== i.type) throw new X("Invalid environment name", i);
                        ...
                        if (!Br.hasOwnProperty(a)) throw new X("No such environment: " + a, i);
                        var s = Br[a],
                        ...
                        r.expect("\\end", !1);
                        var p = r.nextToken,
                            d = Ke(r.parseFunction(), "environment");
                        if (d.name !== a) throw new X("Mismatch: \\begin{" + a + "} matched by \\end{" + d.name + "}", p);
                        return u;
                    }
                });
                var Cr = Ze.makeSpan;
                ...
                function Nr(e, t) {
                    var r = vt(e.body, t, !0);
                    return Cr([e.mclass], r, t);
                }

                function qr(e, t) {
                    var r = Et(e.body, t);
                    return Bt.newDocumentFragment(r);
                }
                ht({
                    type: "mclass",
                ...
                var Lr = function Lr(e, t) {
                        var r = t.style;
                        "display" === e.size ? r = q.DISPLAY : "text" === e.size && r.size === q.DISPLAY.size ? r = q.TEXT : "script" === e.size ? r = q.SCRIPT : "scriptscript" === e.size && (r = q.SCRIPTSCRIPT);
                        var n,
                            i = r.fracNum(),
                            a = r.fracDen();
                        n = t.havingStyle(i);
                        var o = kt(e.numer, n, t);
                        if (e.continued) {
                        ...
                        if (c = e.hasBarLine ? (m = (h = e.barSize ? (m = De(e.barSize, t), Ze.makeLineSpan("frac-line", t, m)) : Ze.makeLineSpan("frac-line", t)).height, h.height) : (h = null, m = 0, t.fontMetrics().defaultRuleThickness), d = r.size === q.DISPLAY.size ? (u = t.fontMetrics().num1, p = 0 < m ? 3 * c : 7 * c, t.fontMetrics().denom1) : (p = 0 < m ? (u = t.fontMetrics().num2, c) : (u = t.fontMetrics().num3, 3 * c), t.fontMetrics().denom2), h) {
                            ...
                            u - o.depth - (x + .5 * m) < p && (u += p - (u - o.depth - (x + .5 * m))), x - .5 * m - (b.height - d) < p && (d += p - (x - .5 * m - (b.height - d)));
                            var w = -(x - .5 * m);
                            f = Ze.makeVList({
                                positionType: "individualShift",
                                children: [{
                            ...
                            var k = u - o.depth - (b.height - d);
                            k < p && (u += .5 * (p - k), d += .5 * (p - k)), f = Ze.makeVList({
                                positionType: "individualShift",
                                children: [{
                                    type: "elem",
                                    elem: b,
                    ...
                    Hr = function Hr(e, t) {
                        var r = new Bt.MathNode("mfrac", [It(e.numer, t), It(e.denom, t)]);
                        if (e.hasBarLine) {
                            if (e.barSize) {
                        ...
                        if (null == e.leftDelim && null == e.rightDelim) return r;
                        var i = [];
                        if (null != e.leftDelim) {
                            var a = new Bt.MathNode("mo", [new Bt.TextNode(e.leftDelim)]);
                            a.setAttribute("fence", "true"), i.push(a);
                        }
                        if (i.push(r), null != e.rightDelim) {
                            var o = new Bt.MathNode("mo", [new Bt.TextNode(e.rightDelim)]);
                ...
                var Dr = ["display", "text", "script", "scriptscript"],
                    Pr = function Pr(e) {
                        var t = null;
                        return 0 < e.length && (t = "." === (t = e) ? null : t), t;
                    };
                ht({
                    type: "genfrac",
                    names: ["\\genfrac"],
                    ...
                    handler: function handler(e, t) {
                        var r = e.parser,
                            ...
                            i = t[5],
                            a = Je(t[0], "ordgroup");
                        a = Qe(a ? a.body[0] : t[0], "open");
                        var o = Pr(a.text),
                            s = Je(t[1], "ordgroup");
                        s = Qe(s ? s.body[0] : t[1], "close");
                        var l,
                            h = Pr(s.text),
                            m = Ke(t[2], "size"),
                            c = null;
                        l = !!m.isBlank || 0 < (c = m.value).number;
                        var u = "auto",
                            p = Je(t[3], "ordgroup");
                        if (p) {
                            if (0 < p.body.length) {
                                var d = Ke(p.body[0], "textord");
                                u = Dr[Number(d.text)];
                            }
                        } else p = Ke(t[3], "textord"), u = Dr[Number(p.text)];
                        return {
                            type: "genfrac",
                            mode: r.mode,
                            numer: n,
                ...
                var Fr = function Fr(e, t) {
                    var r,
                        ...
                        i = t.style,
                        a = Je(e, "supsub");
                    n = a ? (r = a.sup ? kt(a.sup, t.havingStyle(i.sup()), t) : kt(a.sub, t.havingStyle(i.sub()), t), Ke(a.base, "horizBrace")) : Ke(e, "horizBrace");
                    var o,
                        s = kt(n.base, t.havingBaseStyle(q.DISPLAY)),
                        l = Vt(n, t);
                    if (n.isOver ? (o = Ze.makeVList({
                            positionType: "firstBaseline",
                            children: [{
                                type: "elem",
                                elem: s
                        ...
                        }, t)).children[0].children[0].children[1].classes.push("svg-align") : (o = Ze.makeVList({
                            positionType: "bottom",
                        ...
                        var h = Ze.makeSpan(["mord", n.isOver ? "mover" : "munder"], [o], t);
                        o = n.isOver ? Ze.makeVList({
                            positionType: "firstBaseline",
                            children: [{
                                type: "elem",
                                elem: h
                ...
                ht({
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = Ft(e.label);
                        return new Bt.MathNode(e.isOver ? "mover" : "munder", [It(e.base, t), r]);
                    }
                }), ht({
                    type: "href",
                    names: ["\\href"],
                ...
                var Vr = function Vr(e) {
                    ...
                    if (!t) throw new X("Invalid size: '" + e + "' in \\includegraphics");
                    var r = {
                        number: +(t[1] + t[2]),
                        unit: t[3]
                    };
                    if (!He(r)) throw new X("Invalid unit: '" + r.unit + "' in \\includegraphics.");
                    return r;
                };
                ht({
                    ...
                    handler: function handler(e, t, r) {
                        var n = e.parser,
                            ...
                            s = "";
                        if (r[0])
                            for (var l = Ke(r[0], "raw").string.split(","), h = 0; h < l.length; h++) {
                                var m = l[h].split("=");
                                if (2 === m.length) {
                                    var c = m[1].trim();
                                    switch (m[0].trim()) {
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r = De(e.height, t),
                            n = 0;
                        0 < e.totalheight.number && (n = De(e.totalheight, t) - r, n = Number(n.toFixed(2)));
                        var i = 0;
                        0 < e.width.number && (i = De(e.width, t));
                        var a = {
                            height: r + n + "em"
                        };
                        0 < i && (a.width = i + "em"), 0 < n && (a.verticalAlign = -n + "em");
                        var o = new N(e.src, e.alt, a);
                        return o.height = r, o.depth = n, o;
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mglyph", []);
                        r.setAttribute("alt", e.alt);
                        var n = De(e.height, t),
                            i = 0;
                        if (0 < e.totalheight.number && (i = (i = De(e.totalheight, t) - n).toFixed(2), r.setAttribute("valign", "-" + i + "em")), r.setAttribute("height", n + i + "em"), 0 < e.width.number) {
                            var a = De(e.width, t);
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r;
                        r = "clap" === e.alignment ? (r = Ze.makeSpan([], [kt(e.body, t)]), Ze.makeSpan(["inner"], [r], t)) : Ze.makeSpan(["inner"], [kt(e.body, t)]);
                        var n = Ze.makeSpan(["fix"], []),
                            i = Ze.makeSpan([e.alignment], [r, n], t),
                            a = Ze.makeSpan(["strut"]);
                        return a.style.height = i.height + i.depth + "em", a.style.verticalAlign = -i.depth + "em", i.children.unshift(a), i = Ze.makeVList({
                            positionType: "firstBaseline",
                            children: [{
                                type: "elem",
                                elem: i
                            }]
                        }, t), Ze.makeSpan(["mord"], [i], t);
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                    ...
                    handler: function handler(e, t) {
                        ...
                        return n.expect(a, !1), n.switchMode(i), n.consume(), {
                            type: "styling",
                            mode: n.mode,
                            style: "text",
                            body: o
                ...
                var Gr = function Gr(e, t) {
                        var r,
                            ...
                            a = !1,
                            o = Je(e, "supsub");
                        o ? (r = o.sup, n = o.sub, i = Ke(o.base, "op"), a = !0) : i = Ke(e, "op");
                        var s,
                            l = t.style,
                            h = !1;
                        if (l.size === q.DISPLAY.size && i.symbol && !Y.contains(["\\smallint"], i.name) && (h = !0), i.symbol) {
                            var m = h ? "Size2-Regular" : "Size1-Regular",
                                c = "";
                            if ("\\oiint" !== i.name && "\\oiiint" !== i.name || (c = i.name.substr(1), i.name = "oiint" === c ? "\\iint" : "\\iiint"), s = Ze.makeSymbol(i.name, m, "math", t, ["mop", "op-symbol", h ? "large-op" : "small-op"]), 0 < c.length) {
                                var u = s.italic,
                                    p = Ze.staticSvg(c + "Size" + (h ? "2" : "1"), t);
                                s = Ze.makeVList({
                                    positionType: "individualShift",
                                    children: [{
                                        type: "elem",
                                ...
                                }, t), i.name = "\\" + c, s.classes.unshift("mop"), s.italic = u;
                            }
                        } else if (i.body) {
                            var d = vt(i.body, t, !0);
                            1 === d.length && d[0] instanceof O ? (s = d[0]).classes[0] = "mop" : s = Ze.makeSpan(["mop"], Ze.tryCombineChars(d), t);
                        } else {
                        ...
                        var v = 0,
                            y = 0;
                        if ((s instanceof O || "\\oiint" === i.name || "\\oiiint" === i.name) && !i.suppressBaseShift && (v = (s.height - s.depth) / 2 - t.fontMetrics().axisHeight, y = s.italic), a) {
                            var b, x, w;
                            if (s = Ze.makeSpan([], [s]), r) {
                                var k = kt(r, t.havingStyle(l.sup()), t);
                                x = {
                                    elem: k,
                                    kern: Math.max(t.fontMetrics().bigOpSpacing1, t.fontMetrics().bigOpSpacing3 - k.depth)
                                };
                            }
                            if (n) {
                                var S = kt(n, t.havingStyle(l.sub()), t);
                                b = {
                                    elem: S,
                                    kern: Math.max(t.fontMetrics().bigOpSpacing2, t.fontMetrics().bigOpSpacing4 - S.height)
                                };
                            }
                            if (x && b) {
                                var z = t.fontMetrics().bigOpSpacing5 + b.elem.height + b.elem.depth + b.kern + s.depth + v;
                                w = Ze.makeVList({
                                    positionType: "bottom",
                                    positionData: z,
                                    children: [{
                    ...
                    Xr = function Xr(e, t) {
                        var r;
                        if (e.symbol) r = new Tt("mo", [Ct(e.name, e.mode)]);
                        else {
                            if (!e.body) return Mt([r = new Tt("mi", [new At(e.name.slice(1))]), new Tt("mo", [Ct('\u2061', "text")])]);
                            r = new Tt("mo", Et(e.body, t));
                        }
                        return r;
                    },
                    Yr = {
                ...
                ht({
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        if (0 < e.body.length) {
                            for (var r = e.body.map(function(e) {
                                ...
                                var a = n[i];
                                a instanceof O && (a.text = a.text.replace(/\u2212/, "-").replace(/\u2217/, "*"));
                            }
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        for (var r = Et(e.body, t.withFont("mathrm")), n = !0, i = 0; i < r.length; i++) {
                            var a = r[i];
                            if (a instanceof Bt.SpaceNode);
                            else if (a instanceof Bt.MathNode) switch (a.type) {
                                case "mi":
                                case "mn":
                                case "ms":
                                case "mspace":
                                ...
                                case "mo":
                                    var o = a.children[0];
                                    1 === a.children.length && o instanceof Bt.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                                    break;
                                default:
                                    n = !1;
                            } else n = !1;
                        ...
                        if (n) {
                            ...
                            r = [new Bt.TextNode(s, !1)];
                        }
                        var l = new Bt.MathNode("mi", r);
                        l.setAttribute("mathvariant", "normal");
                        var h = new Bt.MathNode("mo", [Ct('\u2061', "text")]);
                        return Bt.newDocumentFragment([l, h]);
                    }
                }), mt({
                    type: "ordgroup",
                    htmlBuilder: function htmlBuilder(e, t) {
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mo", [new Bt.TextNode('\u203E')]);
                        r.setAttribute("stretchy", "true");
                        var n = new Bt.MathNode("mover", [It(e.body, t), r]);
                        return n.setAttribute("accent", "true"), n;
                    }
                }), ht({
                    type: "phantom",
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = Et(e.body, t);
                        return new Bt.MathNode("mphantom", r);
                    }
                }), ht({
                    type: "hphantom",
                    names: ["\\hphantom"],
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r = Ze.makeSpan([], [kt(e.body, t.withPhantom())]);
                ...
                ht({
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r = Ze.makeSpan(["mord", "rule"], [], t),
                            n = 0;
                        e.shift && (n = De(e.shift, t));
                        var i = De(e.width, t),
                            a = De(e.height, t);
                        return r.style.borderRightWidth = i + "em", r.style.borderTopWidth = a + "em", r.style.bottom = n + "em", r.width = i, r.height = a + n, r.depth = -n, r.maxFontSize = 1.125 * a * t.sizeMultiplier, r;
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r = Ze.makeSpan(["mord"], [kt(e.body, t)]);
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        ...
                        var n = t.fontMetrics().defaultRuleThickness,
                            i = n;
                        t.style.id < q.TEXT.id && (i = t.fontMetrics().xHeight);
                        var a = n + i / 4,
                            ...
                            m = s.advanceWidth,
                            c = l.height - h;
                        c > r.height + r.depth + a && (a = (a + c - r.height - r.depth) / 2);
                        ...
                        if (e.index) {
                            var d = t.havingStyle(q.SCRIPTSCRIPT),
                                ...
                                y = Ze.makeSpan(["root"], [v]);
                            return Ze.makeSpan(["mord", "sqrt"], [y, p], t);
                        }
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = e.body,
                            n = e.index;
                        return n ? new Bt.MathNode("mroot", [It(r, t), It(n, t)]) : new Bt.MathNode("msqrt", [It(r, t)]);
                    }
                });
                var Zr = {
                    display: q.DISPLAY,
                ...
                mt({
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        var r,
                            n,
                            i,
                            a = (n = t, (i = (r = e).base) ? "op" !== i.type ? "accent" === i.type ? Y.isCharacterBox(i.base) ? Ut : null : "horizBrace" !== i.type ? null : !r.sub === i.isOver ? Fr : null : i.limits && (n.style.size === q.DISPLAY.size || i.alwaysHandleSupSub) ? Gr : null : null);
                        if (a) return a(e, t);
                        var o,
                            s,
                            l,
                            ...
                            d = 0,
                            f = 0,
                            g = h && Y.isCharacterBox(h);
                        if (m) {
                            var v = t.havingStyle(t.style.sup());
                            o = kt(m, v, t), g || (d = u.height - v.fontMetrics().supDrop * v.sizeMultiplier / t.sizeMultiplier);
                        }
                        if (c) {
                            var y = t.havingStyle(t.style.sub());
                            s = kt(c, y, t), g || (f = u.depth + y.fontMetrics().subDrop * y.sizeMultiplier / t.sizeMultiplier);
                        }
                        l = t.style === q.DISPLAY ? p.sup1 : t.style.cramped ? p.sup3 : p.sup2;
                        var b,
                            x = t.sizeMultiplier,
                            w = .5 / p.ptPerEm / x + "em",
                            k = null;
                        if (s) {
                            var S = e.base && "op" === e.base.type && e.base.name && ("\\oiint" === e.base.name || "\\oiiint" === e.base.name);
                            (u instanceof O || S) && (k = -u.italic + "em");
                        }
                        if (o && s) {
                            d = Math.max(d, l, o.depth + .25 * p.xHeight), f = Math.max(f, p.sub2);
                            var z = 4 * p.defaultRuleThickness;
                            if (d - o.depth - (s.height - f) < z) {
                                f = z - (d - o.depth) + s.height;
                                var M = .8 * p.xHeight - (d - o.depth);
                                0 < M && (d += M, f -= M);
                            }
                            var T = [{
                                type: "elem",
                            ...
                            f = Math.max(f, p.sub1, s.height - .8 * p.xHeight);
                            var A = [{
                                type: "elem",
                                elem: s,
                                marginLeft: k,
                            ...
                            if (!o) throw new Error("supsub must have either sup or sub.");
                            d = Math.max(d, l, o.depth + .25 * p.xHeight), b = Ze.makeVList({
                                positionType: "shift",
                                positionData: -d,
                                children: [{
                                    type: "elem",
                        ...
                        var B = xt(u, "right") || "mord";
                        return Ze.makeSpan([B], [u, Ze.makeSpan(["msupsub"], [b])], t);
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r,
                            n = !1,
                            i = Je(e.base, "horizBrace");
                        i && !!e.sup === i.isOver && (n = !0, r = i.isOver);
                        var a,
                            o = [It(e.base, t)];
                        if (e.sub && o.push(It(e.sub, t)), e.sup && o.push(It(e.sup, t)), n) a = r ? "mover" : "munder";
                        else if (e.sub) {
                            if (e.sup) {
                                var s = e.base;
                                a = s && "op" === s.type && s.limits && t.style === q.DISPLAY ? "munderover" : "msubsup";
                            } else {
                                var l = e.base;
                                a = l && "op" === l.type && l.limits && t.style === q.DISPLAY ? "munder" : "msub";
                            }
                        } else {
                            var h = e.base;
                            a = h && "op" === h.type && h.limits && t.style === q.DISPLAY ? "mover" : "msup";
                        }
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mo", [Ct(e.text, e.mode)]);
                        if ("bin" === e.family) {
                            var n = qt(e, t);
                            "bold-italic" === n && r.setAttribute("mathvariant", n);
                        } else "punct" === e.family && r.setAttribute("separator", "true");
                        return r;
                    }
                });
                var Kr = {
                ...
                mt({
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mi", [Ct(e.text, e.mode, t)]),
                            n = qt(e, t) || "italic";
                        return n !== Kr[r.type] && r.setAttribute("mathvariant", n), r;
                    }
                }), mt({
                    type: "textord",
                    htmlBuilder: function htmlBuilder(e, t) {
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r,
                            ...
                            i = qt(e, t) || "normal";
                        return r = "text" === e.mode ? new Bt.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new Bt.MathNode("mn", [n]) : "\\prime" === e.text ? new Bt.MathNode("mo", [n]) : new Bt.MathNode("mi", [n]), i !== Kr[r.type] && r.setAttribute("mathvariant", i), r;
                    }
                });
                var Jr = {
                        "\\nobreak": "nobreak",
                ...
                mt({
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        if (Qr.hasOwnProperty(e.text)) {
                            var r = Qr[e.text].className || "";
                            if ("text" !== e.mode) return Ze.makeSpan(["mspace", r], [Ze.mathsym(e.text, e.mode, t)], t);
                            var n = Ze.makeOrd(e, t, "textord");
                            return n.classes.push(r), n;
                        }
                        if (Jr.hasOwnProperty(e.text)) return Ze.makeSpan(["mspace", Jr[e.text]], [], t);
                        throw new X('Unknown type of space "' + e.text + '"');
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        if (Qr.hasOwnProperty(e.text)) return new Bt.MathNode("mtext", [new Bt.TextNode("\xa0")]);
                        if (Jr.hasOwnProperty(e.text)) return new Bt.MathNode("mspace");
                        throw new X('Unknown type of space "' + e.text + '"');
                    }
                }), mt({
                    type: "tag",
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mtable", [new Bt.MathNode("mlabeledtr", [new Bt.MathNode("mtd", [Ot(e.tag, t)]), new Bt.MathNode("mtd", [Ot(e.body, t)])])]);
                ...
                var en = {
                    ...
                    nn = function nn(e, t) {
                        var r = e.font;
                        return r ? en[r] ? t.withTextFontFamily(en[r]) : tn[r] ? t.withTextFontWeight(tn[r]) : t.withTextFontShape(rn[r]) : t;
                    };
                ht({
                    type: "text",
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.MathNode("mo", [new Bt.TextNode('\u203E')]);
                        r.setAttribute("stretchy", "true");
                        var n = new Bt.MathNode("munder", [It(e.body, t), r]);
                        return n.setAttribute("accentunder", "true"), n;
                    }
                }), ht({
                    type: "verb",
                    ...
                    htmlBuilder: function htmlBuilder(e, t) {
                        for (var r = an(e), n = [], i = t.havingStyle(t.style.text()), a = 0; a < r.length; a++) {
                            var o = r[a];
                            "~" === o && (o = "\\textasciitilde"), n.push(Ze.makeSymbol(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]));
                        }
                        return Ze.makeSpan(["mord", "text"].concat(i.sizingClasses(t)), Ze.tryCombineChars(n), i);
                    },
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = new Bt.TextNode(an(e)),
                            n = new Bt.MathNode("mtext", [r]);
                ...
                ht({
                    ...
                    mathmlBuilder: function mathmlBuilder(e, t) {
                        var r = Et(e.body, t),
                            n = new Bt.MathNode("mstyle", r);
                        return n.setAttribute("class", e.xmlClass), n;
                    }
                });
                var on = ot,
                    sn = "[ \r\n\t]",
                    ...
                    un = (function() {
                        ...
                        return e.prototype.lex = function() {
                            ...
                            if (t === e.length) return new a("EOF", new p(this, t, t));
                            var r = this.tokenRegex.exec(e);
                            if (null === r || r.index !== t) throw new X("Unexpected character: '" + e[t] + "'", new a(e[t], new p(this, t, t + 1)));
                            var n = r[2] || " ",
                                i = n.match(hn);
                            return i && (n = i[1]), new a(n, new p(this, t, this.tokenRegex.lastIndex));
                        }, e;
                    }()),
                    pn = function() {
                        function e(e, t) {
                        ...
                        return t.beginGroup = function() {
                            ...
                            if (0 === this.undefStack.length) throw new X("Unbalanced namespace destruction: attempt to pop global namespace; please report this as a bug");
                ...
                gn("\\char", function(e) {
                    ...
                    if ("'" === r.text) t = 8, r = e.popToken();
                        ...
                        if ("\\" === (r = e.popToken()).text[0]) n = r.text.charCodeAt(1);
                            ...
                            if ("EOF" === r.text) throw new X("\\char` missing argument");
                            n = r.text.charCodeAt(0);
                        }
                    } else t = 10;
                    if (t) {
                        if (null == (n = vn[r.text]) || t <= n) throw new X("Invalid base-" + t + " digit " + r.text);
                        for (var i; null != (i = vn[e.future().text]) && i < t;) {
                            n *= t, n += i, e.popToken();
                        }
                    }
                    return "\\@char{" + n + "}";
                ...
                var yn = function yn(e, t) {
                    ...
                    if (1 !== r.length) throw new X("\\gdef's first argument must be a macro name");
                    var n = r[0].text,
                        i = 0;
                    for (r = e.consumeArgs(1)[0]; 1 === r.length && "#" === r[0].text;) {
                        if (1 !== (r = e.consumeArgs(1)[0]).length) throw new X('Invalid argument number length "' + r.length + '"');
                        if (!/^[1-9]$/.test(r[0].text)) throw new X('Invalid argument number "' + r[0].text + '"');
                        if (i++, parseInt(r[0].text) !== i) throw new X('Argument number "' + r[0].text + '" out of order');
                        r = e.consumeArgs(1)[0];
                    }
                ...
                gn("\\gdef", function(e) {
                    ...
                    if (1 !== t.length) throw new X("Invalid command after \\global");
                    var r = t[0].text;
                    if ("\\def" === r) return yn(e, !0);
                    throw new X("Invalid command '" + r + "' after \\global");
                });
                var bn = function bn(e, t, r) {
                    var n = e.consumeArgs(1)[0];
                    if (1 !== n.length) throw new X("\\newcommand's first argument must be a macro name");
                    var i = n[0].text,
                        a = e.isDefined(i);
                    if (a && !t) throw new X("\\newcommand{" + i + "} attempting to redefine " + i + "; use \\renewcommand");
                    if (!a && !r) throw new X("\\renewcommand{" + i + "} when command " + i + " does not yet exist; use \\newcommand");
                    var o = 0;
                    if (1 === (n = e.consumeArgs(1)[0]).length && "[" === n[0].text) {
                        for (var s = "", l = e.expandNextToken();
                            "]" !== l.text && "EOF" !== l.text;) {
                            s += l.text, l = e.expandNextToken();
                        }
                        if (!s.match(/^\s*[0-9]+\s*$/)) throw new X("Invalid number of arguments: " + s);
                ...
                var Sn = {
                    ...
                    zn = function() {
                        ...
                        return t.feed = function(e) {
                            ...
                            for (var t = [], r = 0; r < e; ++r) {
                                ...
                                if ("{" === n.text) {
                                    for (var i = [], a = 1; 0 !== a;) {
                                        ...
                                        else if ("EOF" === o.text) throw new X("End of input in macro argument", n);
                                    }
                                    i.pop(), i.reverse(), t[r] = i;
                                } else {
                                    if ("EOF" === n.text) throw new X("End of input expecting macro argument");
                                    t[r] = [n];
                                }
                            }
                            return t;
                            ...
                            if (this.expansionCount++, this.expansionCount > this.settings.maxExpand) throw new X("Too many expansions: infinite loop or need to increase maxExpand setting");
                            var n = r.tokens;
                            if (r.numArgs)
                                for (var i = this.consumeArgs(r.numArgs), a = (n = n.slice()).length - 1; 0 <= a; --a) {
                                    var o = n[a];
                                    if ("#" === o.text) {
                                        if (0 === a) throw new X("Incomplete placeholder at end of macro body", o);
                                        if ("#" === (o = n[--a]).text) n.splice(a + 1, 1);
                                        else {
                                            if (!/^[1-9]$/.test(o.text)) throw new X("Not a valid argument number", o);
                                            var s;
                            ...
                            if (this.macros.get(e)) {
                                var t = [],
                                    r = this.stack.length;
                                for (this.pushToken(new a(e)); this.stack.length > r;) {
                    ...
                    An = function() {
                        ...
                        var e = u.prototype;
                        return e.expect = function(e, t) {
                            if (void 0 === t && (t = !0), this.nextToken.text !== e) throw new X("Expected '" + e + "', got '" + this.nextToken.text + "'", this.nextToken);
                            t && this.consume();
                        }, e.consume = function() {
                            ...
                            for (var r = [];;) {
                                ...
                                if (-1 !== u.endOfExpression.indexOf(n.text)) break;
                                if (t && n.text === t) break;
                                if (e && on[n.text] && on[n.text].infix) break;
                            ...
                            for (var t, r = -1, n = 0; n < e.length; n++) {
                                var i = Je(e[n], "infix");
                                if (i) {
                                    if (-1 !== r) throw new X("only one infix operator per group", i.token);
                                    r = n, t = i.replaceWith;
                                }
                            }
                            if (-1 !== r && t) {
                                ...
                                return a = 1 === s.length && "ordgroup" === s[0].type ? s[0] : {
                                    ...
                                    mode: this.mode,
                                    body: l
                                }, ["\\\\abovefrac" === t ? this.callFunction(t, [a, e[r], o], []) : this.callFunction(t, [a, o], [])];
                            }
                            return e;
                            ...
                            var n = this.parseGroup(e, !1, u.SUPSUB_GREEDINESS);
                            if (!n) throw new X("Expected group after '" + r + "'", t);
                            return n;
                            ...
                            var t,
                                r,
                                n = this.parseGroup("atom", !1, null, e);
                            ...
                            for (;;) {
                                ...
                                if ("\\limits" === i.text || "\\nolimits" === i.text) {
                                    var a = Je(n, "op");
                                    if (!a) throw new X("Limit controls must follow a math operator", i);
                                    var o = "\\limits" === i.text;
                                    a.limits = o, a.alwaysHandleSupSub = !0, this.consume();
                                } else if ("^" === i.text) {
                                    if (t) throw new X("Double superscript", i);
                                    t = this.handleSupSubscript("superscript");
                                } else if ("_" === i.text) {
                                    if (r) throw new X("Double subscript", i);
                                    ...
                                    "^" === this.nextToken.text && l.push(this.handleSupSubscript("superscript")), t = {
                                        type: "ordgroup",
                                        mode: this.mode,
                                        body: l
                                    };
                            ...
                            var n = this.nextToken,
                                ...
                                a = on[i];
                            if (!a) return null;
                            if (null != r && a.greediness <= r) throw new X("Got function '" + i + "' with no arguments" + (t ? " as " + t : ""), n);
                            if ("text" === this.mode && !a.allowedInText) throw new X("Can't use function '" + i + "' in text mode", n);
                            if ("math" === this.mode && !1 === a.allowedInMath) throw new X("Can't use function '" + i + "' in math mode", n);
                            if (a.consumeMode) {
                                var o = this.mode;
                            ...
                            var s = this.parseArguments(i, a),
                                l = s.args,
                                h = s.optArgs;
                            return this.callFunction(i, l, h, n, e);
                            ...
                            for (var n = t.greediness, i = [], a = [], o = 0; o < r; o++) {
                                var s = t.argTypes && t.argTypes[o],
                                    l = o < t.numOptionalArgs;
                                0 < o && !l && this.consumeSpaces(), 0 !== o || l || "math" !== this.mode || this.consumeSpaces();
                                var h = this.nextToken,
                                    m = this.parseGroupOfType("argument to '" + e + "'", s, l, n);
                                if (!m) {
                                    if (l) {
                                        a.push(null);
                                        continue;
                            ...
                            switch (t) {
                                ...
                                case "raw":
                                    ...
                                    throw new X("Expected raw group", this.nextToken);
                                case "original":
                                case null:
                                case void 0:
                            ...
                            for (;
                                "EOF" !== this.nextToken.text && this.nextToken.loc && -1 === this.nextToken.loc.getSource().indexOf("\n");) {
                                this.consume();
                            }
                            if ("EOF" === this.nextToken.text && this.settings.reportNonstrict("commentAtEnd", "% comment has no terminating newline; LaTeX would fail because of commenting the end of math mode (e.g. $)"), "math" === this.mode) this.consumeSpaces();
                            else if (this.nextToken.loc) {
                                var e = this.nextToken.loc.getSource();
                            ...
                            for (var s = "", l = this.nextToken, h = 0, m = l; r && 0 < h || this.nextToken.text !== i;) {
                                switch (this.nextToken.text) {
                                    case "EOF":
                                        throw new X("Unexpected end of input in " + e, l.range(m, s));
                                    case "%":
                                        if (r) break;
                                        this.consumeComment();
                                        continue;
                            ...
                            if (!n) throw new X("Invalid size: '" + t.text + "'", t);
                            var i = {
                                number: +(n[1] + n[2]),
                                unit: n[3]
                            };
                            if (!He(i)) throw new X("Invalid unit: '" + i.unit + "'", t);
                            return {
                                type: "size",
                                mode: this.mode,
                                value: i,
                            ...
                            var a,
                                ...
                                l = this.nextToken,
                                h = l.text;
                            if (i && this.switchMode(i), t ? "[" === h : "{" === h || "\\begingroup" === h) {
                                a = u.endOfGroup[h], this.gullet.beginGroup(), this.consume();
                                var m = this.parseExpression(!1, a),
                                    c = this.nextToken;
                                this.gullet.endGroup(), o = {
                                    type: "ordgroup",
                                    mode: this.mode,
                                    loc: p.range(l, c),
                                    body: m,
                                    semisimple: "\\begingroup" === h || void 0
                                };
                            } else if (t) o = null;
                            else if (null == (o = this.parseFunction(n, e, r) || this.parseSymbol()) && "\\" === h[0] && !Sn.hasOwnProperty(h)) {
                                if (this.settings.throwOnError) throw new X("Undefined control sequence: " + h, l);
                                o = this.handleUnsupportedCmd();
                            }
                            ...
                            if (/^\\verb[^a-zA-Z]/.test(t)) {
                                ...
                                var r = t.slice(5),
                                    n = "*" === r.charAt(0);
                                if (n && (r = r.slice(1)), r.length < 2 || r.charAt(0) !== r.slice(-1)) throw new X("\\verb assertion failed --\n                    please report what input caused this bug");
                                return {
                                    type: "verb",
                                    mode: "text",
                                    body: r = r.slice(1, -1),
                            ...
                            if ("%" === t) return this.consumeComment(), this.parseSymbol();
                            Tn.hasOwnProperty(t[0]) && !W[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = Tn[t[0]] + t.substr(1));
                            var i,
                                a = cn.exec(t);
                            if (a && ("i" === (t = t.substring(0, a.index)) ? t = '\u0131' : "j" === t && (t = '\u0237')), W[this.mode][t]) {
                                this.settings.strict && "math" === this.mode && 0 <= Me.indexOf(t) && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
                                var o,
                                ...
                                if (!(128 <= t.charCodeAt(0))) return null;
                            ...
                            if (this.consume(), a)
                                for (var m = 0; m < a[0].length; m++) {
                                    var c = a[0][m];
                                    if (!Mn[c]) throw new X("Unknown accent ' " + c + "'", e);
                                    var u = Mn[c][this.mode];
                                    if (!u) throw new X("Accent " + c + " unsupported in " + this.mode + " mode", e);
                                    i = {
                                        type: "accent",
                                        mode: this.mode,
                                        loc: p.range(e),
                ...
                An.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"], An.endOfGroup = {
                    "[": "]",
                    "{": "}",
                    "\\begingroup": "\\endgroup"
                }, An.SUPSUB_GREEDINESS = 1;
                var Bn = function Bn(e, t) {
                        ...
                        if (r.gullet.macros.get("\\df@tag")) {
                            if (!t.displayMode) throw new X("\\tag works only in display equations");
                ...
                var Nn = function Nn(e, t, r) {
                        if (r.throwOnError || !(e instanceof X)) throw e;
                        var n = Ze.makeSpan(["katex-error"], [new O(t)]);
                    ...
                    En = {
                        ...
                        __renderToHTMLTree: function __renderToHTMLTree(t, e) {
                            var r,
                                n,
                                i,
                                a = new h(e);
                            try {
                                var o = Bn(t, a);
                                return n = zt(o, Rt(r = a)), i = Ze.makeSpan(["katex"], [n]), r.displayMode ? Ze.makeSpan(["katex-display"], [i]) : i;
                            } catch (e) {
                                return Nn(e, t, a);
                            }
                        },
    ...
    var Doc = function Doc(doc, type) {
        ...
        if (this.root().hasAttribute("v") && this.root().getAttribute("v") != Version.DOC_VERSION) throw Version.DOC_ERROR;
        else this.root().setAttribute("v", Version.DOC_VERSION);
    };
...
<h3>Settings</h3><table id=\"guppy_settings_table\"></table>";
        ...
        if (n.nodeName == "e") {
            ...
            if (text.length == 0) {
                if (n.parentNode.childElementCount == 1) {
                    if (this.current == n) {
                        ...
                        if (this.temp_cursor.node == n) ans = "\\gray{\\xmlClass{guppy_elt guppy_blank guppy_loc_" + n.getAttribute("path") + "_0" + "}{" + blank_placeholder + "}}";
                        else ans = "\\blue{\\xmlClass{guppy_elt guppy_blank guppy_loc_" + n.getAttribute("path") + "_0" + "}{" + blank_placeholder + "}}";
                    }
            ...
            for (var i = 0; i < text.length + 1; i++) {
                if (n == this.current && i == this.caret && (text.length > 0 || n.parentNode.childElementCount > 1)) {
                    ...
                    if (text.length == 0) caret_text = "\\red{\\xmlClass{main_cursor guppy_elt guppy_blank guppy_loc_" + n.getAttribute("path") + "_0}{" + caret_text + "}}";
                    else {
                        caret_text = "\\red{\\xmlClass{main_cursor}{" + caret_text + "}}";
                    }
                    if (this.sel_status == Engine.SEL_CURSOR_AT_START) caret_text = caret_text + "\\" + Utils.SEL_COLOR + "{";
                    else if (this.sel_status == Engine.SEL_CURSOR_AT_END) caret_text = "}" + caret_text;
                    ans += caret_text;
    ...
    */
    ...
    Engine.prototype.insert_nodes = function(node_list, move_cursor) {
        ...
        if (real_clipboard.length == 1) {
            ...
            if (this.current.nextSibling == null) this.current.parentNode.appendChild(nn);
            else this.current.parentNode.insertBefore(nn, this.current.nextSibling);
    ...
    */
    Engine.prototype.sel_delete = function() {
        ...
        if (sel_prev == null) {
            if (sel_parent.firstChild == null) sel_parent.appendChild(sel.remnant);
            else sel_parent.insertBefore(sel.remnant, sel_parent.firstChild);
        } else if (sel_prev.nodeName == 'f') {
            if (sel_prev.nextSibling == null) sel_parent.appendChild(sel.remnant);
            else sel_parent.insertBefore(sel.remnant, sel_prev.nextSibling);
        }
    ...
    */
    ...
    Engine.prototype.set_sel_boundary = function(sstatus, mouse) {
        ...
        if (this.sel_status == Engine.SEL_CURSOR_AT_START) this.set_sel_start();
        else if (this.sel_status == Engine.SEL_CURSOR_AT_END) this.set_sel_end();
    };
    ...
    */
    ...
    Engine.prototype.insert_utf8 = function(codepoint) {
        ...
        if (codepoint <= 0xffff) {
            ...
            this.insert_symbol("utf8codepoint", {
                "name": "UTF8",
    ...
    */
    var Guppy = function Guppy(el) {
        ...
        if (!Settings.config.settings["buttons"]) this.configure("buttons", ["settings", "controls", "symbols"]);
        else this.set_buttons();
        this.render(true);
        this.deactivate();
    ...
    */
    ...
    Guppy.prototype.is_changed = function() {
        ...
        var ans = null;
        if (this.bounding_box) ans = this.bounding_box.top != rect.top || this.bounding_box.bottom != rect.bottom || this.bounding_box.right != rect.right || this.bounding_box.left != rect.left;
        else ans = true;
    ...
    */
    Guppy.prototype.deactivate = function() {
        ...
        this.render();
        Guppy.hide_raw_input();
        if (newly_inactive) this.engine.fire_event("focus", {
            "focused": false
        });
    };
